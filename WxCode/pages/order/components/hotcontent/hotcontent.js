// pages/order/components/hotcontent/hotcontent.js
...
Component({
  ...
  methods: {
    ...
    go_detail(e) {
      ...
      var tstatus = e.currentTarget.dataset.tstatus;
      wx.navigateTo({
        url: '/packageFood/pages/ptorderdetail/ptorderdetail?pkcode=' + pkcode + '&tstatus=' + tstatus,
      })
    },
    // 页面出现函数调取
    onload() {
