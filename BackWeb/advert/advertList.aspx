<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="advertList.aspx.cs" Inherits="CommunityBuy.BackWeb.advertList" %>
    ...
    <form id="form1" data-tbname="advert" runat="server">
        ...
        <div class="fixtop">
            <div class="currentpath">
                <cc1:CPathBar ID="pathBar" PageCode="disheslist" PageType="List" MainMenu="营销管理" SubMenu="广告管理" runat="server"></cc1:CPathBar>
            </div>
            <div class="redline"></div>
            <div class="righttitle">
                <cc1:CPageTitle ID="PageTitle" Menu="广告管理" Operate="List" runat="server"></cc1:CPageTitle>
            </div>
        </div>
        <div class="rightcontent">
            <div class="rightwhere">
                ...
                <ul>
                    <li data-code="" class="wherename">广告类型：</li>
                    <li class="wherevale">
                        <cc1:CDropDownList ID="ddl_selDisheType" Descr="类型" Width="140" SelType="Normal" CssClass="selstyle" runat="server" AutoPostBack="true"></cc1:CDropDownList>
                    </li>
                </ul>
                <ul>
                ...
                <ul>
                    <li data-code="" class="wherename">广告检索：</li>
                    <li class="wherevale">
                ...
                <cc1:CustDataGrid ID="gv_list" runat="server" Width="100%" rules="none" CellPadding="4"
                    ...
                    <Columns>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="CB_Select" runat="server" /><asp:HiddenField ID="HD_Key" Value='<%# Bind("id") %>'  runat="server" />
                            </ItemTemplate>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <a href='javascript:void(0);' id='<%# Eval("id") %>'  onclick="gourl(this)" style="color: dodgerblue;"><%#Eval("title").ToString() %></a>
                            </ItemTemplate>
                        </asp:TemplateColumn>
