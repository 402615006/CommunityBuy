<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dishesRefer.aspx.cs" Inherits="CommunityBuy.BackWeb.dishesRefer" %>
                ...
                if (formpage != undefined && formpage.length > 0)//回调页面方法
                {
                    ...
                    for (var i = 1; i < len; i++) {
                        ...
                        if (flag) {
                            ...
                            dishesarr.disid = $('#gv_list tr:eq(' + i + ') td:eq(1)').find('input:hidden').val();
                            dishesarr.discode = $('#gv_list tr:eq(' + i + ') td:eq(1)').find('span').text();
                            dishesarr.disname = $('#gv_list tr:eq(' + i + ') td:eq(2)').find('span').text();
                            dishesarr.price = $('#gv_list tr:eq(' + i + ') td:eq(5)').text();
                            chooseArr.push(dishesarr);
                        }
                    }
                    switch (formpage) {
                        case "salespromotionEdit"://促销活动页面
                            parent.binddishesinfo(chooseArr);
                            break;
                        case "salespromotionEdit2"://促销活动页面
                            parent.bindmatariainfo(chooseArr);
                            break;
                        case "maincouponedit":
                            parent.maincouponinfo(chooseArr);
                            break;
                    }
                }
                else {
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="HD_stocode" Value='<%# Bind("disid") %>'
                                    runat="server" />
                            </ItemTemplate>
                        </asp:TemplateColumn>
