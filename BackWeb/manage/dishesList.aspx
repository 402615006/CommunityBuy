    ...
    <form id="form1" data-tbname="dishes" runat="server">
        ...
        <div class="rightcontent">
            <div class="rightwhere">
                <ul>
                    <li class="wherename">门店：</li>
                    <li class="wherevale">
                        <cc1:CDropDownList ID="ddl_stocode" Descr="门店" Width="140" SelType="Normal" CssClass="selstyle" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddl_stocode_SelectedIndexChanged"></cc1:CDropDownList>
                    </li>
                </ul>
                <ul>
                ...
                <ul>
                    <li data-code="" class="wherename">菜谱：</li>
                    <li class="wherevale">
                        <cc1:CDropDownList ID="ddl_Menu_list" Descr="菜谱" Width="140" SelType="Normal" CssClass="selstyle" runat="server"></cc1:CDropDownList>
                    </li>
                </ul>
                <ul>
                    <li data-code="" class="wherename">财务类别：</li>
                    <li class="wherevale">
                        <cc1:CDropDownList ID="ddl_selfincode" Descr="财务类别" Width="140" SelType="Normal" CssClass="selstyle" runat="server"></cc1:CDropDownList>
                    </li>
                </ul>
                <ul>
                ...
                <ul>
                    <li data-code="" class="wherename">回收站：</li>
                    <li class="recyble">
                        <cc1:CDropDownList ID="ddl_searchrecyble" Descr="回收站" Width="140" SelType="Normal" CssClass="selstyle" runat="server">
                ...
                <ul>
                    <li data-code="" class="wherename">配置成本卡：</li>
                    <li class="wherevale">
                        <cc1:CDropDownList ID="ddl_cbk" Descr="配置成本卡" Width="140" SelType="Normal" CssClass="selstyle" runat="server">
                            <asp:ListItem Value="1">已配置</asp:ListItem>
                            <asp:ListItem Value="0">未配置</asp:ListItem>
                            <asp:ListItem Value="-1" Selected>全部</asp:ListItem>
                        </cc1:CDropDownList>
                    </li>
                </ul>
                ...
                <cc1:CustDataGrid ID="gv_list" runat="server" Width="100%" rules="none" CellPadding="4"
                    ...
                    <Columns>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="CB_Select" runat="server" /><asp:HiddenField ID="HD_Key" Value='<%# Bind("discode") %>'
                                    runat="server" />
                                <asp:HiddenField ID="DT_Key" Value='<%# Bind("stocode") %>' runat="server" />
                            </ItemTemplate>
                            <HeaderStyle CssClass="chooseclass"></HeaderStyle>
                            <ItemStyle CssClass="chooseclass"></ItemStyle>
                        </asp:TemplateColumn>
                        <%--<asp:BoundColumn DataField="melname" HeaderText="菜谱" />--%>
                        <asp:BoundColumn DataField="stocodename" HeaderText="门店" SortExpression="stocode" />
                        <%--<asp:BoundColumn DataField="kitname" HeaderText="厨房" />--%>
                        ...
                        <asp:BoundColumn DataField="distypename" HeaderText="菜品类别" />
                        <asp:BoundColumn DataField="finname" HeaderText="财务类别" />
                        <asp:BoundColumn DataField="realprice" HeaderText="售价" />
                        <asp:BoundColumn DataField="realmemberprice" HeaderText="会员价" />
                        <asp:TemplateColumn>
                            <HeaderTemplate>毛利率</HeaderTemplate>
                            <ItemTemplate>
                                <a href='javascript:void(0);' id='<%# Eval("discode") %>' stocode='<%# Eval("stocode") %>' onclick="gourl(this)" style="color: dodgerblue;"><%#Eval("mlvprice").ToString() %></a>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <%--<asp:BoundColumn DataField="quickcode" HeaderText="速查码" />
                        <asp:BoundColumn DataField="customcode" HeaderText="自定义编号" />
                        ...
                        <asp:BoundColumn DataField="iscanmodifyprice" HeaderText="可变价" />
                        <asp:BoundColumn DataField="isneedweigh" HeaderText="需称重" />
                        <asp:BoundColumn DataField="isneedmethod" HeaderText="做法必选" />
                        <asp:BoundColumn DataField="iscaninventory" HeaderText="烟酒(可入库)" />
                        <asp:BoundColumn DataField="iscancustom" HeaderText="可自定义" />
                        <asp:BoundColumn DataField="isallowmemberprice" HeaderText="允许会员价" />
                        <asp:BoundColumn DataField="isattachcalculate" HeaderText="参与附加费计算" />
                        <asp:BoundColumn DataField="isclipcoupons" HeaderText="支持使用消费券" />
                        <asp:BoundColumn DataField="iscandeposit" HeaderText="可寄存" />
                        <asp:BoundColumn DataField="isnonoperating" HeaderText="营业外收入" />--%>
                        <asp:BoundColumn DataField="statusname" HeaderText="状态" />
                        <asp:BoundColumn DataField="ctime" HeaderText="创建时间" />
                    </Columns>
                </cc1:CustDataGrid>
