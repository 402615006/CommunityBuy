<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminsRefer.aspx.cs" Inherits="CommunityBuy.BackWeb.adminsRefer" %>
                ...
                <cc1:CustDataGrid ID="gv_list" runat="server" Width="100%" rules="none" CellPadding="4"
                    ...
                    <columns>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lb_stocode" Text='<%# Bind("userid") %>' runat="server" />
                                <asp:HiddenField ID="HD_stocode" Value='<%# Bind("userid") %>'
                                    runat="server" />
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn>
