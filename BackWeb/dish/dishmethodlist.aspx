<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dishmethodlist.aspx.cs" Inherits="CommunityBuy.BackWeb.dish.dishmethodlist" %>
    ...
    <form id="form1" data-tbname="dishmethod" runat="server">
        ...
        <div class="fixtop">
            <div class="currentpath">
                <cc1:CPathBar ID="pathBar" PageCode="rolefunctionlist" PageType="Normal" MainMenu="餐品管理" SubMenu="规格管理" runat="server"></cc1:CPathBar>
            </div>
            <div class="redline"></div>
            <div class="righttitle">
                <cc1:CPageTitle ID="PageTitle" Menu="餐品规格管理" Operate="新建" runat="server"></cc1:CPageTitle>
            </div>
        </div>
        <div class="rightcontent">
            <div class="height25 gray"> </div>
            <div class="operbtn">
                <asp:LinkButton ID="LinkAdd" runat="server" CommandName="add" OnClientClick="checklist('add');return false;" Visible="true"><div class="operlinkbtn"><img src="/img/operations/add.png" /><span data-code="add_button" class="fontcolor">添加</span></div></asp:LinkButton>
            </div>
            <div class="height25 gray"> </div>
...
<%--                            <div class="savebtn">
                            ...
                            <asp:Button ID="Save_btn" runat="server" Text="保存" CssClass="savebtn" OnClientClick="PageCheck();"  OnClick="Save_btn_Click" />
                            <%--<cc1:CButton ID="Save_btn" runat="server" Text="保存" CssClass="savebtn" OnClientClick="PageCheck();"  OnClick="Save_btn_Click" IsFormValidation="false" />--%>
