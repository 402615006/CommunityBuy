<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" CodeBehind="dishesedit.aspx.cs" Inherits="CommunityBuy.BackWeb.dishesedit" %>
        ...
        $(function () {
            ...
            layui.use('upload', function () {
                ...
                var uploadInst = upload.render({
                    ...
                    // , size: 50
                    , multiple: true
                    , data: { filetype: 'dishimage', pwd: 'combuy' }
    ...
    <form id="form1" data-tbname="dishes" runat="server">
        ...
        <div class="fixtop">
            <div class="currentpath">
                <cc1:CPathBar ID="pathBar" PageCode="disheslist" PageType="Edit" MainMenu="商品管理" SubMenu="商品管理" runat="server"></cc1:CPathBar>
            </div>
            <div class="redline"></div>
            <div class="righttitle">
                <cc1:CPageTitle ID="PageTitle" Menu="商品管理" Operate="编辑" runat="server"></cc1:CPageTitle>
            </div>
        </div>
        <div class="rightcontent">
            <div class="height25 gray">&nbsp;</div>
            <div class="labelledlist">
                <div id="tab_info" data-code="tab1" class="graydiv" title="cla">商品信息</div>
            </div>
            <div class="updatediv cla" style="height: 1000px; overflow-y: auto;">
                <table>
                    <tr>
                        <td>
                            <label for="stocode">商家:</label></td>
                        <td style="text-align: left;">
                            <cc1:CDropDownList ID="ddlStore" Descr="商家" Width="140" SelType="Normal" CssClass="selstyle" runat="server"></cc1:CDropDownList>
                        </td>
                        <td>
                            <label for="" data-code="span_distypecode">商品类别</label></td>
                        <td style="text-align: left;">
                    ...
                    <tr>
                        <td>
                            <label for="disname" data-code="span_disname">商品名称</label></td>
                        <td style="text-align: left;">
                            <input id="txt_disname" runat="server" type="text" onchange="getPinyin()" data-code="disname_placeholder" class="reqtxtstyle" maxlength="32" data-notempty="true" /></td>
                        <td>
                            <label for="" data-code="span_disothername">详情地址</label></td>
                        <td style="text-align: left;">
                            <input id="txt_disothername" runat="server" maxlength="128" type="text" value="" class="txtstyle" data-code="disothername_placeholder"/></td>
                        <td>
                            <label for="" data-code="span_quickcode">速查码</label></td>
                        <td style="text-align: left;">
                            <input id="txt_quickcode" runat="server" data-code="quickcode_placeholder" maxlength="32" class="reqtxtstyle" type="text" value="" data-notempty="true"/></td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <input id="txt_selunit" type="text" runat="server" data-code="unit_placeholder" maxlength="8" class="reqtxtstyle" data-notempty="true" /></td>
                        <td>
                            <label for="" data-code="span_price">售价</label></td>
                        <td style="text-align: left;">
                            <input id="txt_price" maxlength="18" runat="server" type="text" value="" class="reqtxtstyle" data-notempty="true" data-reg="Decimal"/>
                            </td>
                          <td>
                            <label for="" data-code="span_costprice">成本价</label>
                        </td>
                          <td style="text-align: left;">
                            <input id="txt_costprice" runat="server" maxlength="18" type="text" value="" class="reqtxtstyle" data-notempty="true" data-reg="Decimal">
                        </td>
                    </tr>
                    <tr>
                         <td>
                        ...
                        <td style="text-align: left;" colspan="5">
                            <textarea id="txt_remark" runat="server" style="width:90%; height: 90px;margin-top:10px; "></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                             <cc1:CButton ID="Save_btn" runat="server" OnClick="Save_btn_Click" IsFormValidation="false" Text="保存"/>
                        </td>
                        <td colspan="5">
