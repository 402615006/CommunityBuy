                ...
                <cc1:CustDataGrid ID="gv_list" runat="server" Width="100%" rules="none" CellPadding="4"
                    ...
                    <Columns>
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate>
                                <asp:CheckBox ID="CB_Select" runat="server" /><asp:HiddenField ID="HD_Key" Value='<%# Bind("memcode") %>'
                                    runat="server" />
                            </ItemTemplate>
                        ...
                        <asp:TemplateColumn>
                            ...
                            <ItemTemplate><a href="membersDetail.aspx?id=<%#Eval("memcode").ToString() %>"><%#Eval("totalcard").ToString() %></a></ItemTemplate>
                        </asp:TemplateColumn>
