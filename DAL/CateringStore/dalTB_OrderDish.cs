    ...
    public partial class dalTB_OrderDish
    {
        ...
        public int Add(ref TB_OrderDishEntity Entity)
        {
            ...
            SqlParameter[] sqlParameters = 
            {
				...
				new SqlParameter("@ReturnNum", Entity.ReturnNum),
				...
				new SqlParameter("@DiscountPrice", Entity.DiscountPrice),
				new SqlParameter("@DiscountRemark", Entity.DiscountRemark),
				new SqlParameter("@DiscountType", Entity.DiscountType),
				new SqlParameter("@DisCase", Entity.DisCase),
				new SqlParameter("@Favor", Entity.Favor),
				new SqlParameter("@ItemNum", Entity.ItemNum),
				new SqlParameter("@ItemPrice", Entity.ItemPrice),
				new SqlParameter("@CookName", Entity.CookName),
				new SqlParameter("@CookMoney", Entity.CookMoney),
