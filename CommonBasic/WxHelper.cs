...
namespace CommunityBuy.CommonBasic
{
    ...
    public class WxHelper
    {
        ...
        {
            var appId = ConfigurationManager.AppSettings["appid"].ToString().Trim();
            var appSecret = ConfigurationManager.AppSettings["secret"].ToString().Trim();
        ...
        public string Decrypt(string encryptedData, string iv, string sessionKey)
        {
            ...
            {
                ErrorLog.WriteErrorMessage(ErrorLog.LogType.baselog, "encryptedData:" + encryptedData + ";微信解密错误：" + ex.ToString());
                result = "fail";
            }
